...
class StudentCardScreen extends StatefulWidget {
  final Map<String, dynamic> studentData; // Renomeado para mais clareza
  const StudentCardScreen(this.studentData, {Key? key}) : super(key: key);
  ...
  Widget _buildFrontCard() {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          FrontCard(widget.studentData), // Usando studentData corretamente
        ],
      ),
    );
  }
  ...
  Widget _buildBackCard() {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          BackCard(widget.studentData), // Usando studentData corretamente
        ],
      ),
    );
  }
